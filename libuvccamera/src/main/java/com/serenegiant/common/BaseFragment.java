...
import androidx.annotation.NonNull; // Changed from android.support.annotation.NonNull
import androidx.annotation.StringRes; // Changed from android.support.annotation.StringRes
import android.util.Log;
import android.widget.Toast;

import com.serenegiant.dialog.MessageDialogFragmentV4; // Changed from MessageDialogFragment
...
public class BaseFragment extends Fragment
	implements MessageDialogFragmentV4.MessageDialogListener { // Changed MessageDialogFragment to MessageDialogFragmentV4
...
//================================================================================
	...
	@SuppressLint("NewApi")
	@Override
	public void onMessageDialogResult(final MessageDialogFragmentV4 dialog, final int requestCode, final String[] permissions, final boolean result) { // Changed MessageDialogFragment to MessageDialogFragmentV4
		if (result) {
	...
	protected boolean checkPermissionWriteExternalStorage() {
		if (!PermissionCheck.hasWriteExternalStorage(getActivity())) {
			MessageDialogFragmentV4.showDialog(this, REQUEST_PERMISSION_WRITE_EXTERNAL_STORAGE, // Changed MessageDialogFragment to MessageDialogFragmentV4
	...
	protected boolean checkPermissionAudio() {
		if (!PermissionCheck.hasAudio(getActivity())) {
			MessageDialogFragmentV4.showDialog(this, REQUEST_PERMISSION_AUDIO_RECORDING, // Changed MessageDialogFragment to MessageDialogFragmentV4
	...
	protected boolean checkPermissionNetwork() {
		if (!PermissionCheck.hasNetwork(getActivity())) {
			MessageDialogFragmentV4.showDialog(this, REQUEST_PERMISSION_NETWORK, // Changed MessageDialogFragment to MessageDialogFragmentV4
	...
	protected boolean checkPermissionCamera() {
		if (!PermissionCheck.hasCamera(getActivity())) {
			MessageDialogFragmentV4.showDialog(this, REQUEST_PERMISSION_CAMERA, // Changed MessageDialogFragment to MessageDialogFragmentV4
